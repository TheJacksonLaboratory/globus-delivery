...
SOURCE_ENDPOINT = '04bbcb48-107b-11ea-8a67-0e35e66293c2'
# Globus Tutorial Endpoint 2
DESTINATION_ENDPOINT = 'b8377de1-47c2-11e7-bd5c-22000b9a448b'
# Copy data off of the endpoint share
SOURCE_PATH = 'napari_omero'

# Destination Path -- The directory will be created if it doesn't exist
DESTINATION_PATH = '/projects/researchit/ratame/sync-demo/'
...
CLIENT_ID = '6264dd74-051b-4655-b41f-61595cbb5040'
